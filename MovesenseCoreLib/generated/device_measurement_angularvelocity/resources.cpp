...
WB_STATIC_VERIFY(sizeof(GyroConfig) == 2, SizeOfStructure_GyroConfig_IsNotWhatExpected);
WB_STATIC_VERIFY(WB_TYPE_ALIGNMENT(GyroConfig) == 2, AlignmentOfStructure_GyroConfig_IsNotWhatExpected);

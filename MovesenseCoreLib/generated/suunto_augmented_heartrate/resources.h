...
#include "../suunto_fusion_heartrate/resources.h"
...
struct AugmentationStateValues
{
	...
	enum Type
	{
		...
		CALIBRATING = 1U,
		AUGMENTING = 2U,
		CALIBRATION_FAILED = 3U
	};
};
typedef whiteboard::TypedEnum<AugmentationStateValues, AugmentationStateValues::Type, uint8> AugmentationState;
...
struct AUGMENTED_HEARTRATE;

struct AUGMENTED_HEARTRATE_AVERAGE
{
	...
	struct GET
	{
		typedef HeartRateData Response_HTTP_CODE_OK_Type;
...
struct AUGMENTED_HEARTRATE_STATE
{
	static const whiteboard::ExecutionContextId EXECUTION_CONTEXT = WB_EXEC_CTX_MEAS;
	...
	struct GET
	{
		typedef AugmentationState Response_HTTP_CODE_OK_Type;
	...
	struct EVENT
	{
		typedef AugmentationState NotificationType;
	};

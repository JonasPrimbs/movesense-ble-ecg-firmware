...
struct WB_STRUCT_PACKED TxPow
{
	...
	static const whiteboard::LocalDataTypeId DATA_TYPE_ID = 19712;
...
struct WB_STRUCT_PACKED TestMode
{
	// Structure type identification and serialization
	typedef int Structure;
	static const whiteboard::LocalDataTypeId DATA_TYPE_ID = 19713;
...
struct COMPONENT_NRF52;

struct COMPONENT_NRF52_TEST;

struct COMPONENT_NRF52_TEST_MODE
{
	static const whiteboard::ExecutionContextId EXECUTION_CONTEXT = WB_EXEC_CTX_PRIMARYSERVICES;
	static const whiteboard::ResourceId::Value ID = WB_RESOURCE_VALUE(0, 19712, EXECUTION_CONTEXT);
	static const whiteboard::LocalResourceId LID = 19712;
	...
	struct PUT
	{
		...
		/** Reference wrapper for strongly typed parameter list for /Component/Nrf52/Test/Mode */
...
struct COMPONENT_NRF52_TEST_TXPOW
{
	static const whiteboard::ExecutionContextId EXECUTION_CONTEXT = WB_EXEC_CTX_PRIMARYSERVICES;
	static const whiteboard::ResourceId::Value ID = WB_RESOURCE_VALUE(0, 19713, EXECUTION_CONTEXT);
	static const whiteboard::LocalResourceId LID = 19713;
	...
	struct PUT
	{
		...
		/** Reference wrapper for strongly typed parameter list for /Component/Nrf52/Test/TxPow */
		class ParameterListRef
		{
		private:
			/** Prevent use of default constructor */

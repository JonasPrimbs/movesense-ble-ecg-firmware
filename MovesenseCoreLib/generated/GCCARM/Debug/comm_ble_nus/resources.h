...
struct WB_ALIGN(4) NUSData;

struct WB_ALIGN(4) NUSData
{
	// Structure type identification and serialization
	typedef int Structure;
	static const whiteboard::LocalDataTypeId DATA_TYPE_ID = 20736;
...
struct COMM_BLE_NUS
{
	...
	static const whiteboard::ResourceId::Value ID = WB_RESOURCE_VALUE(0, 20736, EXECUTION_CONTEXT);
	static const whiteboard::LocalResourceId LID = 20736;
	...
	struct POST
	{
		...
		/** Reference wrapper for strongly typed parameter list for /Comm/Ble/NUS */
	...
	struct EVENT
	{
		typedef NUSData NotificationType;

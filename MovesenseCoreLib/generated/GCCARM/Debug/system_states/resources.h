...
struct SYSTEM_STATES_STATEID
{
	...
	struct GET
	{
		typedef whiteboard::StronglyTypedResult<State, whiteboard::HTTP_CODE_OK> HTTP_CODE_OK;
		...
		struct Parameters
		{
			...
			typedef STATEID Parameter1;

			static const whiteboard::ParameterIndex NUMBER_OF_PARAMETERS = 1;
		};

		/** Reference wrapper for strongly typed parameter list for /System/States/{StateId} */
		...
		public:
			...
			*/
			...
			/** Gets STATEID parameter value
			*
			* @return Current parameter value
			*/
			inline Parameters::STATEID::ConstReferenceType getStateId() const
			{
				return mrParameterList[Parameters::STATEID::Index].convertTo<Parameters::STATEID::ConstReferenceType>();
			}
		...
		inline static void typeCheck(
			Parameters::STATEID::ConstReferenceType)
		{
		}
	};
	...
	struct EVENT
	{
		typedef StateChange NotificationType;
		...
		public:
			...
			*/
			...
			/** Checks whether optional parameter STATEID has a value
			*
			* @return A value indicating whether the parameter has a value
			*/
			inline bool hasStateId() const
			{
				if (mrParameterList.getNumberOfParameters() <= Parameters::STATEID::Index)
				{
					return false;
				}

				return mrParameterList[Parameters::STATEID::Index].getType() != whiteboard::WB_TYPE_NONE;
			}
		...
		inline static void typeCheck(
			...
			const whiteboard::Api::OptionalParameter<Parameters::STATEID::ConstReferenceType>& = whiteboard::NoType::NoValue)
		{
		}
	};

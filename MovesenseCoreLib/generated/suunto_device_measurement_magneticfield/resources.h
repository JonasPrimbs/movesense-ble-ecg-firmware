...
struct WB_STRUCT_PACKED MagnConfig
{
	// Structure type identification and serialization
	typedef int Structure;
	static const whiteboard::LocalDataTypeId DATA_TYPE_ID = 5121;
...
struct WB_STRUCT_PACKED MagnData
{
	// Structure type identification and serialization
	typedef int Structure;
	static const whiteboard::LocalDataTypeId DATA_TYPE_ID = 5122;
...
{
	static const whiteboard::ExecutionContextId EXECUTION_CONTEXT = WB_EXEC_CTX_MEAS;
	static const whiteboard::ResourceId::Value ID = WB_RESOURCE_VALUE(0, 5121, EXECUTION_CONTEXT);
	static const whiteboard::LocalResourceId LID = 5121;
...
{
	static const whiteboard::ExecutionContextId EXECUTION_CONTEXT = WB_EXEC_CTX_MEAS;
	static const whiteboard::ResourceId::Value ID = WB_RESOURCE_VALUE(0, 5122, EXECUTION_CONTEXT);
	static const whiteboard::LocalResourceId LID = 5122;

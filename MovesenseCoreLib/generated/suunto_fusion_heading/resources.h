...
struct FUSION_HEADING
{
	static const whiteboard::ExecutionContextId EXECUTION_CONTEXT = WB_EXEC_CTX_MEAS;
	static const whiteboard::ResourceId::Value ID = WB_RESOURCE_VALUE(0, 10752, EXECUTION_CONTEXT);
	static const whiteboard::LocalResourceId LID = 10752;

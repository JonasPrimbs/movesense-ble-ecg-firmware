...
struct FUSION_SLOPE
{
	...
	static const whiteboard::ResourceId::Value ID = WB_RESOURCE_VALUE(0, 11520, EXECUTION_CONTEXT);
	static const whiteboard::LocalResourceId LID = 11520;
...
struct FUSION_SLOPE_DIRECTION
{
	static const whiteboard::ExecutionContextId EXECUTION_CONTEXT = WB_EXEC_CTX_MEAS;
	static const whiteboard::ResourceId::Value ID = WB_RESOURCE_VALUE(0, 11521, EXECUTION_CONTEXT);
	static const whiteboard::LocalResourceId LID = 11521;

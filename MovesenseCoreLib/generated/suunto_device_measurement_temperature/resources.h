...
struct WB_STRUCT_PACKED TemperatureValue
{
	...
	static const whiteboard::LocalDataTypeId DATA_TYPE_ID = 5632;
...
struct DEVICE_MEASUREMENT_TEMPERATURE
{
	...
	static const whiteboard::ResourceId::Value ID = WB_RESOURCE_VALUE(0, 5632, EXECUTION_CONTEXT);
	static const whiteboard::LocalResourceId LID = 5632;

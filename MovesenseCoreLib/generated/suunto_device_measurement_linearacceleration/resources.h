...
struct WB_STRUCT_PACKED AccInfo
{
	...
	static const whiteboard::LocalDataTypeId DATA_TYPE_ID = 4864;
...
struct WB_STRUCT_PACKED AccConfig
{
	// Structure type identification and serialization
	typedef int Structure;
	static const whiteboard::LocalDataTypeId DATA_TYPE_ID = 4865;
...
struct WB_STRUCT_PACKED AccData
{
	// Structure type identification and serialization
	typedef int Structure;
	static const whiteboard::LocalDataTypeId DATA_TYPE_ID = 4866;
...
struct MEAS_ACC_CONFIG
{
	static const whiteboard::ExecutionContextId EXECUTION_CONTEXT = WB_EXEC_CTX_MEAS;
	static const whiteboard::ResourceId::Value ID = WB_RESOURCE_VALUE(0, 4864, EXECUTION_CONTEXT);
	static const whiteboard::LocalResourceId LID = 4864;

	struct GET
	{
		typedef AccConfig Response_HTTP_CODE_OK_Type;
	...
	struct PUT
	{
		...
		/** Reference wrapper for strongly typed parameter list for /Meas/Acc/Config */
...
struct MEAS_ACC_INFO
{
	static const whiteboard::ExecutionContextId EXECUTION_CONTEXT = WB_EXEC_CTX_MEAS;
	static const whiteboard::ResourceId::Value ID = WB_RESOURCE_VALUE(0, 4865, EXECUTION_CONTEXT);
	static const whiteboard::LocalResourceId LID = 4865;

	struct GET
	{
		typedef AccInfo Response_HTTP_CODE_OK_Type;
...
{
	static const whiteboard::ExecutionContextId EXECUTION_CONTEXT = WB_EXEC_CTX_MEAS;
	static const whiteboard::ResourceId::Value ID = WB_RESOURCE_VALUE(0, 4866, EXECUTION_CONTEXT);
	static const whiteboard::LocalResourceId LID = 4866;
	...
	struct SUBSCRIBE
	{
		...
		/** Reference wrapper for strongly typed parameter list for /Meas/Acc/{SampleRate} */
		class ParameterListRef
		{
		private:
			/** Prevent use of default constructor */
	...
	struct EVENT
	{
		typedef AccData NotificationType;
	};

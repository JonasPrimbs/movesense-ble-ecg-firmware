...
struct WB_STRUCT_PACKED LinearAccelerationValue;
...
struct WB_STRUCT_PACKED LinearAccelerationValue
{
	...
	static const whiteboard::StructureValueSerializer<LinearAccelerationValue> serializer;
	WB_WHEN_STRUCTURE_CLEANING_NEEDED(static const whiteboard::StructureValueCleaner<LinearAccelerationValue> cleaner;)

	WB_ALIGN(4) uint32 relativeTime;
	WB_ALIGN(4) whiteboard::Optional< FloatVector3DArray > measurement;
...
struct DEVICE_MEASUREMENT_LINEARACCELERATION
{
	...
	struct GET
	{
		typedef LinearAccelerationValue Response_HTTP_CODE_OK_Type;
	...
	struct EVENT
	{
		typedef LinearAccelerationValue NotificationType;
	};
...
struct DEVICE_MEASUREMENT_LINEARACCELERATION_HIGHSPEED
{
	static const whiteboard::ExecutionContextId EXECUTION_CONTEXT = WB_EXEC_CTX_MEAS;

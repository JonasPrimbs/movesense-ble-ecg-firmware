...
struct MEAS_ACC_CONFIG
{
	...
	static const whiteboard::ResourceId::Value ID = WB_RESOURCE_VALUE(0, 15104, EXECUTION_CONTEXT);
	static const whiteboard::LocalResourceId LID = 15104;

	struct GET
	{
		typedef whiteboard::StronglyTypedResult<const AccConfig&, whiteboard::HTTP_CODE_OK> HTTP_CODE_OK;
...
{
	static const whiteboard::ExecutionContextId EXECUTION_CONTEXT = WB_EXEC_CTX_MEAS;
	static const whiteboard::ResourceId::Value ID = WB_RESOURCE_VALUE(0, 15105, EXECUTION_CONTEXT);
	static const whiteboard::LocalResourceId LID = 15105;

	struct GET
	{
		typedef whiteboard::StronglyTypedResult<const AccInfo&, whiteboard::HTTP_CODE_OK> HTTP_CODE_OK;
...
{
	static const whiteboard::ExecutionContextId EXECUTION_CONTEXT = WB_EXEC_CTX_MEAS;
	static const whiteboard::ResourceId::Value ID = WB_RESOURCE_VALUE(0, 15106, EXECUTION_CONTEXT);
	static const whiteboard::LocalResourceId LID = 15106;

...
/* #undef BUILD_HAL_WANT_SKISENSE_MSM */
#define BUILD_HAL_WANT_PERSISTENT_SYSTEMEVENT
#define BUILD_HAL_WANT_SYSTEMEVENT_ON_DEBUGOUT
#define BUILD_HAL_WANT_BATTERY_LOGGING

#define BUILD_HAL_EEPROM_DRIVER
#define BUILD_HAL_EXTFLASH_DRIVER

#define BUILD_HAL_BATTERY_GAUGE_DRIVER_SIMU
#define BUILD_HAL_PMIC_DRIVER_NONE
#define BUILD_HAL_HEARTRATE_DRIVER_SIMU
#define BUILD_HAL_TEMPERATURE_DRIVER_SIMU
#define BUILD_HAL_1WIRE_DRIVER_SIMU

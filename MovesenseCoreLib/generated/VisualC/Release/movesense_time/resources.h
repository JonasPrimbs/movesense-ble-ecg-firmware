...
struct WB_ALIGN(8) DetailedTime
{
	...
	static const whiteboard::LocalDataTypeId DATA_TYPE_ID = 1792;
...
struct TIME
{
	...
	static const whiteboard::ResourceId::Value ID = WB_RESOURCE_VALUE(0, 1792, EXECUTION_CONTEXT);
	static const whiteboard::LocalResourceId LID = 1792;
	...
	struct PUT
	{
		...
		/** Reference wrapper for strongly typed parameter list for /Time */
...
struct TIME_DETAILED
{
	static const whiteboard::ExecutionContextId EXECUTION_CONTEXT = WB_EXEC_CTX_APPLICATION;
	static const whiteboard::ResourceId::Value ID = WB_RESOURCE_VALUE(0, 1793, EXECUTION_CONTEXT);
	static const whiteboard::LocalResourceId LID = 1793;

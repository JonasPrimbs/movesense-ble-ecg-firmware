...
if (MSVC)
	...
	if (NOT DEFINED SDL_LIB_PATH)
		set(SDL_LIB_PATH ${MOVESENSE_CORE_LIBRARY}/lib/VisualC/${HWCONFIG})
		set(SDL_NET_LIB_PATH ${SDL_LIB_PATH})
		set(SDL_TTF_LIB_PATH ${SDL_LIB_PATH})
		set(SDLMAIN_LIB_PATH ${SDL_LIB_PATH})
	endif()
    link_libraries(${SDL_LIB_PATH}/SDL2.lib)
    link_libraries(${SDL_NET_LIB_PATH}/SDL2_net.lib)
    link_libraries(${SDL_TTF_LIB_PATH}/SDL2_ttf.lib)
    link_libraries(${SDLMAIN_LIB_PATH}/SDL2main.lib)
endif()

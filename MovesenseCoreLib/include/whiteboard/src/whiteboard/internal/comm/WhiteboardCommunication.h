...
class WhiteboardCommunication FINAL : private IExecutionContext
{
public:
    /**
    * Constructor
...
private:
    ...
    *
    * @param destinationWhiteboardId ID of destination whiteboard
    * @param rpDestination On output contains the message destination
    * @param rpNextHop On output contains next hop on route to destination
    ...
    */
    Result prepareMessageRouting(
        ...
        RoutingTableEntry*& rpDestination,
    ...
    *
    * @param rNextHop Next hop on route to message destination
...
private:
    ...
    * @param result Result code of the operation	 */
    void returnError(SendRequest* pRequest, Result resultCode);

...
class WB_API CommAdapter : public ICommunicationInterface
{
public:
    /** CommAdapter traits */
    struct Traits
    ...
    * @return Result of the operation
    */
    Result disable(bool removeAdapterRoutes) OVERRIDE FINAL;
    ...
    */
    virtual Result addRoute(
        const char* address, const char* serialNumber, bool buddy, RoutingTableEntryHandle& rRouteHandle) OVERRIDE = 0;
    ...
    * @return Result of the operation
    */
    Result removeRoute(const RoutingTableEntryHandle& rRouteHandle) OVERRIDE FINAL;
    ...
    */
    void removeRoutes() OVERRIDE FINAL;

...
#define WB_HEAP_TRACE_DECLARE_WRAPPER(...) \
    WB_HEAP_TRACE_DECLARE_WRAPPER_N(WB_ARGCOUNT(__VA_ARGS__), __VA_ARGS__)

#ifdef _MSC_VER
#define WB_HEAP_TRACE_DECLARE_WRAPPER_N(n, ...) WB_CONCATENATE(WB_HEAP_TRACE_DECLARE_WRAPPER_I(n, __VA_ARGS__)(__VA_ARGS__, ), )
#define WB_HEAP_TRACE_DECLARE_WRAPPER_I(n, ...) WB_CONCATENATE(WB_HEAP_TRACE_DECLARE_WRAPPER_, n)
#else
...
#define WB_HEAP_TRACE_DECLARE_VOID_WRAPPER(...) \
    WB_HEAP_TRACE_DECLARE_VOID_WRAPPER_N(WB_ARGCOUNT(__VA_ARGS__), __VA_ARGS__)

#ifdef _MSC_VER
#define WB_HEAP_TRACE_DECLARE_VOID_WRAPPER_N(n, ...) WB_CONCATENATE(WB_HEAP_TRACE_DECLARE_VOID_WRAPPER_I(n, __VA_ARGS__)(__VA_ARGS__,),)
#define WB_HEAP_TRACE_DECLARE_VOID_WRAPPER_I(n, ...) WB_CONCATENATE(WB_HEAP_TRACE_DECLARE_VOID_WRAPPER_, n)
#else
...
#define WB_HEAP_TRACE_DEFINE_WRAPPER(...) \
    WB_HEAP_TRACE_DEFINE_WRAPPER_N(WB_ARGCOUNT(__VA_ARGS__), __VA_ARGS__)

#ifdef _MSC_VER
#define WB_HEAP_TRACE_DEFINE_WRAPPER_N(n, ...) WB_CONCATENATE(WB_HEAP_TRACE_DEFINE_WRAPPER_I(n, __VA_ARGS__)(__VA_ARGS__, ), )
#define WB_HEAP_TRACE_DEFINE_WRAPPER_I(n, ...) WB_CONCATENATE(WB_HEAP_TRACE_DEFINE_WRAPPER_, n)
#else
...
#define WB_HEAP_TRACE_DEFINE_VOID_WRAPPER(...) \
    WB_HEAP_TRACE_DEFINE_VOID_WRAPPER_N(WB_ARGCOUNT(__VA_ARGS__), __VA_ARGS__)

#ifdef _MSC_VER
#define WB_HEAP_TRACE_DEFINE_VOID_WRAPPER_N(n, ...) WB_CONCATENATE(WB_HEAP_TRACE_DEFINE_VOID_WRAPPER_I(n, __VA_ARGS__)(__VA_ARGS__,),)
#define WB_HEAP_TRACE_DEFINE_VOID_WRAPPER_I(n, ...) WB_CONCATENATE(WB_HEAP_TRACE_DEFINE_VOID_WRAPPER_, n)
#else
...
#define WB_HEAP_TRACE_WRAPPER(...) \
    WB_HEAP_TRACE_WRAPPER_N(WB_ARGCOUNT(__VA_ARGS__), __VA_ARGS__)

#ifdef _MSC_VER
#define WB_HEAP_TRACE_WRAPPER_N(n, ...) WB_CONCATENATE(WB_HEAP_TRACE_WRAPPER_I(n, __VA_ARGS__)(__VA_ARGS__, ),)
#define WB_HEAP_TRACE_WRAPPER_I(n, ...) WB_CONCATENATE(WB_HEAP_TRACE_WRAPPER_, n)
#else
...
#define WB_HEAP_TRACE_DEFINE_WRAPPER_2(retType, func, ...) \
    retType wbht_ ## func(const char* callerFile, size_t callerLine, const char* callerFunc) \
    { \
        heapTraceEnter(callerFile, callerLine, callerFunc, WB_STRINGIFY(func)); \
        retType result = func(); \
        heapTraceExit(callerFile, callerLine, callerFunc, WB_STRINGIFY(func)); \
        return result; \
    }
...
#define WB_HEAP_TRACE_DEFINE_VOID_WRAPPER_2(func, p1Type, ...) \
    void wbht_ ## func(const char* callerFile, size_t callerLine, const char* callerFunc, p1Type p1) \
    { \
        heapTraceEnter(callerFile, callerLine, callerFile, WB_STRINGIFY(func)); \
        func(p1); \
        heapTraceExit(callerFile, callerLine, callerFunc, WB_STRINGIFY(func)); \
    }

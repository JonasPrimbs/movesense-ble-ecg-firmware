...
void vPortCloseRunningThread( void *pxTaskToDelete, volatile BaseType_t *pxPendYield );
void vPortDeleteThread( void *pxThreadToDelete );
...
/*
 * Yield within API. API functions yielding do not expect call to return before
 ...
 */
void vPortSetInterruptHandler( uint32_t ulInterruptNumber, uint32_t (*pxHandler)( void ) );

 ...
 * 
 */ 
template <typename Input, typename Coefficient, typename Accumulator, size_t NUMBER_OF_TAPS>
class SimpleFIR
{
public:
    SimpleFIR(const Coefficient (&coeffs)[NUMBER_OF_TAPS])
    : mCoeffs(coeffs), mIndex(0)
    {

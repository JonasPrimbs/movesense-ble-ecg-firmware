...
function(INIT_SIMULATOR_ENVIRONMENT)
    if(${BSP} MATCHES "SDL")
        if (MSVC)
            ...
            file(GLOB VS_DLLS
                "${FW_PATH}/vendor/SDL2/VisualC/SDL2-2.0.4/lib/${VS_BITNESS}/*.dll"
                "${FW_PATH}/vendor/SDL2/VisualC/SDL2_net-2.0.1/lib/${VS_BITNESS}/*.dll"
                "${FW_PATH}/vendor/SDL2/VisualC/SDL2_ttf-2.0.14/lib/${VS_BITNESS}/*.dll")
            file(GLOB VS_FONTS ${FW_PATH}/vendor/SDL/*.ttf)
